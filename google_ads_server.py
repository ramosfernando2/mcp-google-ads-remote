...
GOOGLE_ADS_CREDENTIALS_PATH = os.environ.get("GOOGLE_ADS_CREDENTIALS_PATH", "/app/credentials.json")
...
class BearerAuthMiddleware:
    """Rejects any request that doesn't carry the expected static bearer token."""
...
if __name__ == "__main__":
    ...
    if transport_mode == "http":
        ...
        # Start the MCP server on stdio transport (local/desktop usage)
